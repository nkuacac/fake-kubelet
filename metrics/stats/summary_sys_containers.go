...
func (sp *summaryProviderImpl) GetSystemContainersStats(nodeConfig NodeConfig, podStats []statsapi.PodStats, updateStats bool) (stats []statsapi.ContainerStats) {
...
func (sp *summaryProviderImpl) GetSystemContainersCPUAndMemoryStats(nodeConfig NodeConfig, podStats []statsapi.PodStats, updateStats bool) (stats []statsapi.ContainerStats) {
	systemContainers := map[string]struct {
		name             string
		forceStatsUpdate bool
		startTime        metav1.Time
